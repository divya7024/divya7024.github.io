...
<html>
<head><title>cart notification</title>
<link rel="stylesheet" type="text/css" href="./style/style.css"/>
</head>
<body>
	<header><span class="cont">truYum </span>
...
<div>
   ...
   <table class="cont">
		...
		<tr>
			...
			<td class="txt-center"><a href="RemoveCart?menuItemId=${menu.id}" target="_blank">Delete</a></td>
		</tr>
